    ...
    const rows = [
        {
            ...
            time: '08:00',
            date: '07/07/2025',
            place: 'H6-910 Bách Khoa Dĩ An',
        },
        {
            stt: 2,
            time: '16:00',
            date: '25/07/2025',
            place: 'Quán Cafe ABC Tầng 2',
        },
        {
            stt: 3,
            time: '08:00',
            date: '02/08/2025',
            place: 'google.meet.com/dsad-das-dsad',
        },
    ...
    return (
        <div className="form-change-schedule-container">
            ...
            <div className="group-button">
                ...
                <button className="btn-save" onClick={() => setShowFormChangeSchedule(false)}>
                    Lưu
                </button>
            </div>
        </div>
