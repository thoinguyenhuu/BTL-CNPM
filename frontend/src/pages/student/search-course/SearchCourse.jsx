    ...
    return (
        <div className='search-course-container'>
            ...
            <div className='list-container'>
                <input type={'text'} placeholder={'Tìm kiếm khóa học'} className={'search-course-input'}/>
                ...
                <table>
                    ...
                    {courses.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td>{item.mode}</td>
                            <td>
                                <span className={item.status === "Đã đăng ký" ? "status-badge registered" : "status-badge register"}>
                                    {item.status}
                                </span>
                            </td>
                        </tr>
